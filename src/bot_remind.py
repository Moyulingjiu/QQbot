...
async def sendClockResetMessage(groupId):
    ...
    reply += '\n统计信息如下：'
    reply += '\n退群数：' + str(bot_information['statistics']['quit'])
    reply += '\n禁言次数：' + str(bot_information['statistics']['mute'])
    reply += '\n解除禁言次数：' + str(bot_information['statistics']['unmute'])
    reply += '\n唤醒次数：' + str(bot_information['statistics']['awaken'])
    reply += '\n帮助文档获取次数：' + str(bot_information['statistics']['help'])
    reply += '\n基础功能调用次数：' + str(bot_information['statistics']['base_function'])
    reply += '\ntalk模块调用次数：' + str(bot_information['statistics']['talk'])
    reply += '\nclock_activity模块调用次数：' + str(bot_information['statistics']['clock_activity'])
    reply += '\nimage_search模块调用次数：' + str(bot_information['statistics']['image_search'])
    reply += '\ncommand模块调用次数：' + str(bot_information['statistics']['command'])
    reply += '\noperate模块调用次数：' + str(bot_information['statistics']['operate'])
    reply += '\ngame模块调用次数：' + str(bot_information['statistics']['game'])
    reply += '\n自动加一次数：' + str(bot_information['statistics']['auto_repeat'])
    reply += '\n自主回复次数：' + str(bot_information['statistics']['auto_reply'])

    bot_information['statistics']['quit'] = 0
    bot_information['statistics']['mute'] = 0
    bot_information['statistics']['unmute'] = 0

    bot_information['statistics']['awaken'] = 0
    bot_information['statistics']['help'] = 0
    bot_information['statistics']['base_function'] = 0
    bot_information['statistics']['talk'] = 0
    bot_information['statistics']['clock_activity'] = 0
    bot_information['statistics']['image_search'] = 0
    bot_information['statistics']['command'] = 0
    bot_information['statistics']['operate'] = 0
    bot_information['statistics']['game'] = 0
    bot_information['statistics']['auto_repeat'] = 0
    bot_information['statistics']['auto_reply'] = 0
