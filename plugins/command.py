...
def helpAdministrators():
    ...
    result += '8.打卡情况 群号：返回某个群的打卡情况\n'
    result += '9.版本信息：返回小柒的版本信息\n'
    result += '--------------------------\n'
...
def allCommand():
    ...
    result += '2.添加管理员 账号：向贡献者计划中加入新人\n'
    result += '3.命令大全：返回命令大全\n'
    result += '4.删除文摘 序号：删除某一条文摘\n'
    result += '5.删除情话 序号：删除某一条情话\n'
    result += '6.添加黑名单 群 群号：将该群加入黑名单\n'
    result += '7.添加黑名单 人 QQ号：将该人加入黑名单\n'
    result += '8.移除黑名单 群 群号：将该群移除黑名单\n'
    result += '9.移除黑名单 人 QQ号：将该人移除黑名单\n'
    result += '10.修改版本信息 版本号：远程修改版本信息\n'
    return result
