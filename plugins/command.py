...
def helpAdministrators():
    ...
    result += '3.文摘条数：返回当前有多少条文摘\n'
    result += '4.情话条数：返回当前有多少条情话\n'
    result += '5.小柒报告状况：报告小柒的运行状况\n'
    result += '6.打卡情况 群号：返回某个群的打卡情况\n'
    result += '6.版本信息：返回小柒的版本信息\n'
    result += '--------------------------\n'
